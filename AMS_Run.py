...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global mycursor
            connection = pymysql.connect(host='localhost', user='root', password='Msdhoni@123', db='manually_fill_attendance')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global mycursor
                    connection = pymysql.connect(host='localhost', user='root', password='Msdhoni@123', db='Face_reco_fill')
                    mycursor = connection.cursor()
                except Exception as e:
                    print(e)
